...
export function Header() {
  ...
  const mantineHeaderStyles = useMemo(
    () => ({
      ...
      backgroundColor:
        colorScheme === 'dark' ? alpha(theme.colors.dark[7], 0.8) : alpha(theme.white, 0.8),
      ...
      <Group justify='space-between'>
        <Flex align={'center'} h='100%'>
          <Box hiddenFrom='sm'>
            <Burger
              opened={!hideNavbar}
              onClick={() => setHideNavbar((o: boolean) => !o)}
              size='sm'
        ...
        <Flex align={'center'} hiddenFrom='sm'>
          <Menu shadow='md' width={200}>
            ...
            <Menu.Dropdown>
              <Menu.Item leftSection={<IconUserCircle size='1.125rem' stroke={1.5} />}>
                Trang cá nhân
              </Menu.Item>
              <Menu.Item
                leftSection={
